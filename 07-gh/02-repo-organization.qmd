...
We are developing a repository template with a defined directory structure that you can use as a starting point for new emLab projects. To use the template, click **Use this template** on the **INSERT LINK** repository.
