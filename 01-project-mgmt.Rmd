...
Example 1: Clean seafood grouping tasks by complete v. not complete.

![](images/airtable-groupcomplete.png)

Example 2: Clean seafood grouping deliverables by research track.
...
![Dowload Drive File Stream](images/shared-drive-download-installer.png)
...
This section provides a brief overview of how Git and Github work, how to install them on your computer (and how to join the emLab GitHub page), and some general guidelines for how to use GitHub to organie code associated with emLab projects. 
...
7. Optional: Make a repository on GitHub and practice connecting to it

[Do a practice example here].

8. Optional: Install a client for Git to make your life easier
...
The GitHub [Projects feature](https://github.com/orgs/emlab-ucsb/projects) provides project management tools for planning, creating and assigning tasks, and tracking progress. Project boards help organize and prioritize work. They can be specific to one repo or used to connect multiple repos under the same project. Within repos, Issues and Pull Requests should be used for discussion, creating and assigning tasks, code review, etc., which are connected to project boards.

The GitHub [Teams feature](https://github.com/orgs/emlab-ucsb/teams) allows for subgroups within the emLab GitHub organization, which enables easier communication among teams and better access control for repos.
