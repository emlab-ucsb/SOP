...
Modern research workflows often involve complex, interconnected scripts where the output of one file is the input for the next. Traditional "numbered script" approaches (e.g., `01_clean.R`, `02_model.R`) are prone to error: if you change a parameter in `01_clean.R`, you must remember to manually re-run everything downstream.  
