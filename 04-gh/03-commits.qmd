...
**The subject line** should be a concise summary of the change. It should be capitalized, written in the imperative mood (as though giving an instruction), ended without a period, and no longer than 50 characters.^[If you wish, see https://cbea.ms/git-commit/ for an explanation of the reasoning behind these rules.]  For example:
