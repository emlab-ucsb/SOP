...
* **Pipe pocumentation:** When using long `magrittr` or base R pipes (`%>%` or `|>`), place comments above the specific line of the pipe that performs a complex or non-intuitive transformation.
...
We encourage the use of AI tools to accelerate the documentation process and improve the clarity of our codebase. However, the researcher is always responsible for the accuracy and technical integrity of all documentation.
...
#### Claude Code
Claude Code is our preferred AI tool for high-level project documentation, architectural overviews, and refactoring legacy scripts.
...
AI can "hallucinate" the intent of a function or describe a parameter incorrectly. Always read through AI-generated text to ensure it accurately reflects the code's behavior and intent.
