...
- **Actually run the code.** For accuracy or reproducibility review, running the code yourself is often the only way to catch certain classes of errors. If the repo is set up correctly (see [Pipeline reproducibility](pipeline-reproducibility.qmd) and [Package reproducibility](package-reproducibility.qmd)), this should be straightforward.
