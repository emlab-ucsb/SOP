...
The following universal requirements reflect our shared commitment to a research environment that supports excellent, collaborative code development at emLab. These are described in detail in the following sections.

**GitHub is the platform for all coding work**
...
- **File paths:** Avoid writing file paths that only work on your computer. Use relative file paths instead of absolute ones so your code can be run by different users or operating systems. For R users, the [here](https://github.com/jennybc/here_here) package is a great way to help implement this practice.
