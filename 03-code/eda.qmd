...
* **Interpretability:** Every plot should be followed by a short sentence describing the takeaway (e.g., *"The outlier in 2014 appears to be a recording error in the raw sensor data"*).
...
* **Avoid View() in files**: Never leave View(df) in a code chunk, as it will break the rendering process. Use head() or DT::datatable() instead.  
