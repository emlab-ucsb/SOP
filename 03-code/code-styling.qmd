...
In a collaborative environment where projects span years and multiple contributors, **style is a form of documentation.**
...
At emLab, we have adopted Rust-based formatters that are significantly faster than older tools and can be configured to run automatically every time you save a file.  


::: {.callout-important}

To maintain consistency across emLab, the use of these formatters is **required** for all new code development.
