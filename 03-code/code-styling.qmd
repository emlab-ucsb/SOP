...
In a collaborative environment where projects span years and multiple contributors, code is a medium of communication and **style is a form of documentation.**
...
At emLab, we have adopted cutting-edge Rust-based formatters that are significantly faster than older tools and can be configured to run automatically every time you save a file.  
