...
- **GitHub Pro, Team, and Free for organizations** (which covers the `emlab-ucsb` org): Pages can publish directly from either public or **private** repos. For a private repo, the source code stays hidden while the rendered site is publicly accessible at its `*.github.io` URL.
