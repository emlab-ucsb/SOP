...
### Connecting to Emlab's Team Drive
...
After installation you need to authorize `google-drive-ocamlfuse` and create a label for the connection. Labels are useful if you want to mount your personal drive as well as EmLabs Team Drive. To authorize and create a label for our shared drive run: 
