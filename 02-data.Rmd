...
<!--
    Note to self: update the text on this first page to be broader than data
-->
...
## Metadata 
*Add text about where/store data for each dataset. This is different than the data directory, which is meta-metadata.
