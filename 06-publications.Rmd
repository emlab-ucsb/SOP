...
We would love to share any publicly available datasets on the emLab website. Any time you release a publicly available dataset, please Slack or email Erin O'Reilly (eoreilly@ucsb.edu) the following information: your name, link to the dataset, date published, and the emLab project it is associated with.
