...
# Note that if you use a different Team Drive file structure than the one recommended in the "File Structure" section, you will need to manually define your data path.
...
# This will automatically determine if the project exists in the "current-projects" or "archived-projects" Team Drive folder, and set the appropriate data path accordingly.
...
# Load data from Team Drive using appropriate data path
